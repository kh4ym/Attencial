...
namespace Attencial.Client.Pages
{
	...
	public class Home : ComponentBase
	{
		...
		protected override void BuildRenderTree(RenderTreeBuilder __builder)
		{
			...
			{
				__builder.AddMarkupContent(19, "<a class=\"font-label-caps text-label-caps bg-primary text-surface px-5 py-3 no-underline transition-all duration-300 hover:scale-[1.03] inline-block animate-pulse-subtle border border-primary\" href=\"login\">LOGIN</a>\n                    ");
				__builder.AddMarkupContent(20, "<a class=\"font-label-caps text-label-caps bg-surface text-on-surface border border-on-surface px-5 py-3 no-underline transition-all duration-300 hover:scale-[1.03] hover:bg-[#fdf5f5] hover:border-primary/40 inline-block\" href=\"register\">SIGN UP</a>");
			}
			__builder.CloseElement();
			__builder.CloseElement();
			__builder.CloseElement();
			...
			__builder.AddMarkupContent(32, "<h1 class=\"font-display-lg text-display-lg text-on-surface mb-6 max-w-2xl\" style=\"animation: gentle-rise 0.9s 0.25s ease both;\">\n                        Streamline Your <span class=\"text-primary italic\">Academic</span> Attendance\n                    </h1>\n                    ");
			...
			__builder.AddMarkupContent(63, "<a href=\"/\" class=\"flex items-center gap-3 no-underline group mb-4\"><div class=\"w-10 h-10 border-2 border-primary flex items-center justify-center relative\"><span class=\"material-symbols-outlined text-primary text-2xl group-hover:scale-110 transition-transform\">visibility</span>\n                        <div class=\"absolute -top-[2px] -right-[2px] w-2 h-2 bg-primary rounded-full\"></div></div>\n                    <span class=\"font-display-lg text-headline-md font-bold text-on-surface tracking-tighter\">Attencial</span></a>\n                ");
